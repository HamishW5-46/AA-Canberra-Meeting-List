...
/** Set all styles */
$onlineBackgroundImage = $attributes['onlineBackgroundImage'] ?? null;
if ($onlineBackgroundImage === '../img/online-image.jpeg') {
    $onlineBackgroundImage = plugins_url('../../img/online-image.jpeg', __FILE__);
}
...
$styles = [
    ...
    '--online-background-image' => $onlineBackgroundImage ? 'url('.$onlineBackgroundImage.')' : null,
    "--font-size" => $size ?? null,
];
