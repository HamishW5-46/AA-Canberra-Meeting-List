...
/**
 * Send a formatted TSML email.
 *
 * Used by tsml_ajax_feedback() and save.php for change notifications.
 *
...
function tsml_email( $to, $subject, $message, $reply_to = false ) {
    ...
    /*
     * Apply email-safe inline styling to markup generated by TSML.
     */
    $message = str_replace(
        [
            '<p>',
        ...
        [
            ...
            '<a style="color:#005ea8; text-decoration:underline;" ',
                ...
                >
                    ...
                    <tr>
                        ...
                        ">
                            ...
                            ' . esc_html( $site_name ) . ' meeting system.
                            ...
                            >' . esc_html( wp_parse_url( $site_url, PHP_URL_HOST ) ) . '</a>
                        </td>
                    </tr>
