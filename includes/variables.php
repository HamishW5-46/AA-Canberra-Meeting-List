...
// AA Canberra custom fork: contacts are always public.
...
// AA Canberra custom fork: distance units are always kilometres.
...
// AA Canberra custom fork: the public meeting list always uses TSML UI.
$tsml_user_interface = 'tsml_ui';

// AA Canberra custom fork: automatic imports are always enabled.
$tsml_auto_import = 'on';
...
// AA Canberra custom fork: the program is always Alcoholics Anonymous.
$tsml_program = 'aa';
...
// AA Canberra custom fork: the timezone is always Sydney.
